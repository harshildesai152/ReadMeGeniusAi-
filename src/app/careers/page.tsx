...
import { LogIn, UserPlus, LogOut, LayoutDashboard, Home, Briefcase } from 'lucide-react';
        ...
        <Card className="w-full shadow-xl border hover:border-foreground transition-colors duration-200">
          <CardHeader className="items-center pb-4 sm:pb-6">
            <CardTitle className="text-2xl sm:text-3xl md:text-4xl font-bold text-center font-headline flex items-center gap-2 sm:gap-3">
              <Briefcase className="h-7 w-7 sm:h-8 sm:h-8 md:h-9 md:w-9 text-primary" />
              Careers
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm text-muted-foreground">Join our mission to simplify developer documentation.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5 sm:space-y-6 text-sm sm:text-base leading-relaxed sm:leading-loose">
            <p className="text-center text-muted-foreground">
              We're always looking for talented individuals passionate about AI, developer tools, and creating great user experiences.
            </p>
            <p className="text-center text-muted-foreground">
              Currently, we do not have any open positions. However, please check back soon or follow us on our (yet to be created) social media channels for future opportunities!
            </p>
            <div className="text-center mt-6">
              <Link href="/" passHref>
                <Button>
                  Explore ReadMeGenius
                </Button>
              </Link>
            </div>
          </CardContent>
