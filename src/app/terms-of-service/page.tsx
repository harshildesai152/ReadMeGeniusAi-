...
import { LogIn, UserPlus, LogOut, LayoutDashboard, Home, ScrollText } from 'lucide-react';
        ...
        <Card className="w-full shadow-xl border hover:border-foreground transition-colors duration-200">
          <CardHeader className="items-center pb-4 sm:pb-6">
            <CardTitle className="text-2xl sm:text-3xl md:text-4xl font-bold text-center font-headline flex items-center gap-2 sm:gap-3">
              <ScrollText className="h-7 w-7 sm:h-8 sm:h-8 md:h-9 md:w-9 text-primary" />
              Terms of Service
            </CardTitle>
          ...
          <CardContent className="space-y-5 sm:space-y-6 text-sm sm:text-base leading-relaxed sm:leading-loose prose dark:prose-invert max-w-none">
            <p>Welcome to our AI README Generator. By using our site, you agree to the following terms:</p>

            <h2>Use of the Service</h2>
            <p>You may use our generator for personal or commercial projects.</p>
            <p>You agree not to misuse the service (e.g., for unlawful or harmful purposes).</p>

            <h2>Intellectual Property</h2>
            <p>All generated content is yours to use freely.</p>
            <p>The underlying AI technology and website design remain our property.</p>

            <h2>Limitation of Liability</h2>
            <p>We do our best to ensure accurate results, but we make no guarantees.</p>
            <p>We are not liable for any losses or issues arising from generated content.</p>

            <h2>Changes to Terms</h2>
            <p>We reserve the right to update these terms at any time.</p>
            <p>Continued use after updates indicates acceptance.</p>
          </CardContent>
        </Card>
