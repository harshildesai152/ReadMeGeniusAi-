...
import { LogIn, UserPlus, LogOut, LayoutDashboard, Home, CreditCard } from 'lucide-react';
        ...
        <Card className="w-full shadow-xl border hover:border-foreground transition-colors duration-200">
          <CardHeader className="items-center pb-4 sm:pb-6">
            <CardTitle className="text-2xl sm:text-3xl md:text-4xl font-bold text-center font-headline flex items-center gap-2 sm:gap-3">
              <CreditCard className="h-7 w-7 sm:h-8 sm:h-8 md:h-9 md:w-9 text-primary" />
              Pricing Plans
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm text-muted-foreground">Choose a plan that fits your needs.</CardDescription>
          </CardHeader>
          <CardContent className="space-y-5 sm:space-y-6 text-sm sm:text-base leading-relaxed sm:leading-loose">
            <p className="text-center text-muted-foreground">
              Our pricing plans are coming soon! We aim to offer a free tier for basic usage and premium plans for advanced features and higher limits.
            </p>
            <p className="text-center text-muted-foreground">
              Check back later for more details on available plans and features.
            </p>
            <div className="text-center mt-6">
              <Link href="/" passHref>
                <Button>
                  Use ReadMeGenius for Free
                </Button>
              </Link>
            </div>
          </CardContent>
